      ...
      <div className="hidden flex-1 flex-col justify-between p-12 lg:flex">
        ...
        <div>
          ...
          >
            MORE THAN
            <br />
            A <span className="text-primary">COURT</span>
          </h1>
          <p className="max-w-[400px] text-[1.05rem] leading-relaxed text-text-muted">
            Sign in to manage your bookings, discover courts, and connect with the Courtly community.
          </p>
        </div>
        ...
        <div className="w-full max-w-[440px]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex justify-end">
              <Link href="#" className="text-[0.85rem] font-medium text-primary transition-colors hover:text-primary-hover">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-8 text-center text-[0.9rem] text-text-muted">
            ...
            <Link href="/signup" className="font-semibold text-primary transition-colors hover:text-primary-hover">
              Sign Up
            </Link>
          </p>
        </div>
