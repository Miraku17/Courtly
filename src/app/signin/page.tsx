...
export default function SignInPage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      const destination = data.user.role === "PLAYER" ? "/player/bookings" : "/venue-owner";
      ...
      <div className="flex flex-1 items-center justify-center p-4 sm:p-6 lg:p-12 bg-bg-dark relative overflow-y-auto overflow-x-hidden">
        ...
        >
          ...
          <div className="my-8 flex items-center gap-4">
            ...
            <span className="text-[0.65rem] font-bold uppercase tracking-[0.2em] text-text-muted/30">OR CONTINUE WITH</span>
            <div className="h-px flex-1 bg-white/5" />
          </div>
