...
const navItems = [
  { name: "Dashboard", label: "Home", icon: LayoutDashboard, href: "/admin" },
  { name: "Venues", label: "Venues", icon: Building2, href: "/admin/venues" },
];
      ...
      <aside className="hidden md:flex w-64 flex-col fixed h-full z-50 bg-bg-dark">
        ...
        <div className="px-6 pt-7 pb-5 border-b border-white/8">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            />
            <span className="font-panchang text-white font-bold text-[1.1rem] tracking-tight">
              COURTIFY
            </span>
          </Link>
        ...
        <nav className="flex-1 px-3 pt-4 space-y-0.5">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <item.icon
                  className={cn("size-[17px]", isActive ? "text-white" : "")}
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-2.5">
            <div className="text-right">
              <p className="text-[0.75rem] font-bold text-text-dark leading-tight">
                {displayName}
              </p>
              <p className="text-[0.6rem] text-text-muted-dark/50">Admin</p>
            </div>
            <div className="size-9 rounded-xl border border-section-dark/10 bg-white/60 flex items-center justify-center overflow-hidden">
              {profileData?.profile?.avatar_url ? (
                ...
                <User
                  size={16}
                  className="text-text-muted-dark/50"
                />
              )}
            </div>
          </div>
          ...
          >
            ...
            >
              <div className="relative p-6 pt-8 flex flex-col items-center text-center">
                ...
                <h3 className="text-[1.1rem] font-bold text-text-dark mb-1.5">
                  Sign out?
                </h3>
